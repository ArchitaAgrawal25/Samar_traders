    ...
    <div className="min-h-screen bg-[#faf8f4]">
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-[1240px] px-4 pb-12 pt-28 sm:px-5 md:px-3 md:pt-32 lg:px-2">
          <div className="hero-windows mb-8 flex items-center justify-center gap-2 opacity-0">
            <Link
              to="/"
            ...
            <span className="text-stone-300">›</span>
            <span className="font-sans text-[0.58rem] font-semibold uppercase tracking-[0.16em] text-[#2a7a6a]">
              Windows
            </span>
          </div>
